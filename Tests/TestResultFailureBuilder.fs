...
let ``ValidationFailure should take an expected and an actual and return a ValidationFailure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.ValidationFailure ("45", false, "Z:/Test/blah.fs", 99)
...
let ``GeneralTestExpectationFailure should convert a message into a failure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.GeneralTestExpectationFailure ("A message as to why this fails", "G:\\Test\\Place\\file.fs", 87)
...
let ``IgnoreFailure should take a message and return a failure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.IgnoreFailure ("I ignored this", "F:\\A\\Dir\\aFile.fs", 29)
...
let ``IgnoreFailure should take Some (message) and return a failure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.IgnoreFailure (Some "I ignored this also", "Q:\\myFile.fsx", 42)
...
let ``IgnoreFailure should take None and return a failure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.IgnoreFailure (None, "Y:\\Z\\a.xls", 1)
...
let ``IgnoreFailure should return a failure`` =
    feature.Test (
        fun builder _ ->
            let result = builder.IgnoreFailure ("E:\\t.ts", 90)
